...
- `days_late` (int): number of days the assignment is late
**Outputs**
- `adjusted_grade` (float): grade after late penalty applied
```{python}
from ubc_mds_helper.assessment import late_assignment
